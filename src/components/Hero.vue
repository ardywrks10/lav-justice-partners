<template>
  <section class="relative flex min-h-[85vh] w-full items-center justify-center overflow-hidden bg-gray-100">
    ...
    <div class="container mx-auto px-6 sm:px-10 relative z-10 w-full">
      <div class="grid grid-cols-1 lg:grid-cols-12 text-center lg:text-left">
        <div class="col-span-1 lg:col-span-6 xl:col-span-5 rounded-sm border border-white/70 bg-white/95 py-8 px-6 sm:px-8 shadow-2xl backdrop-blur-md backdrop-saturate-200">
          ...
          <p class="text-lg font-semibold mb-8 mt-5 text-gray-600 leading-relaxed max-w-lg mx-auto lg:mx-0">
          ...
          <div class="mb-8 flex flex-col sm:flex-row justify-center gap-4 lg:justify-start">
            <button class="px-7 py-3.5 bg-[#051962] text-white text-sm font-bold tracking-widest rounded-none border border-[#051962] shadow-md transition-all shadow-md transform hover:-translate-y-0.5">
                Jelajahi Layanan
            </button>
